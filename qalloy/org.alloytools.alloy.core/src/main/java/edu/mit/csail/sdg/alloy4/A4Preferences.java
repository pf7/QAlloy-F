...
public class A4Preferences {
    ...
    public static final StringChoicePref             AnalysisType           = new StringChoicePref("AnalysisType", "Analysis context", Arrays.asList("Boolean", "Fuzzy"), "Fuzzy");
    ...
    public static final StringChoicePref             Tnorm           = new StringChoicePref("T-norm", "T-norm", Arrays.asList("Gödelian", "Łukasiewicz", "Product", "Drastic", "Einstein", "ADD_MIN", "MAX_PRODUCT"), "Gödelian");
